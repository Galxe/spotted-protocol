...
import {IServiceManager, ISpottedServiceManager} from "../interfaces/ISpottedServiceManager.sol";
import {IServiceManagerUI} from "eigenlayer-middleware/src/interfaces/IServiceManagerUI.sol";
...
abstract contract ECDSAServiceManagerBase is ISpottedServiceManager, OwnableUpgradeable {
    ...
    /// @notice Address of the PermissionController contract
     ...
     */
    function __ECDSAServiceManagerBase_init(
